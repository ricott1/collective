...
const doSubscription = async subscription => {
  try {
    ...
    let parts = [subscription.fromAddress, subscription.toAddress, subscription.tokenAddress, subscription.tokenAmount, subscription.periodSeconds, subscription.gasPrice, subscription.nonce]
